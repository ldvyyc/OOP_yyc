...
void Graph::InsertConstant(const string &node_name, float value) {
    ...
    //ConstantNode a(node_name, value);
...
void Graph::InsertOperation(const string &node_name, const string &operation_type, 
    ...
    if (operation_type.compare("+")==0){
        //oper1 a(node_name, nodes_[input1], nodes_[input2]);
        nodes_.insert(node_name,new oper1(node_name, nodes_[input1], nodes_[input2]));
    }
    else{
        //oper2 b(node_name, nodes_[input1], nodes_[input2]);
        nodes_.insert(node_name,new oper2(node_name, nodes_[input1], nodes_[input2]));
    }
}
